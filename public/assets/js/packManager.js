...
formAddPack.addEventListener("submit",async function(event){
    ...
    if(formData.get("categorie") =="primaire" || formData.get("categorie") =="college" || formData.get("categorie") =="secondaire" ||  formData.get("categorie") =="bac"){
        formData.append("type","fourniture")
    }else{
...
// affichage du annee scolaire select apres la selection du type = livre
let selectItem = document.querySelector("#categorie")
selectItem.addEventListener("change",function(){
    if(selectItem.value == "livre"){
